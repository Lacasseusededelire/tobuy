...
class FirestoreService {
  ...
  final String _listsCollection = 'shopping_lists';
    ...
    try {
      ...
      await _firestore.runTransaction((transaction) async {
        ...
        if (updatedItems.length < currentList.items.length) {
          ...
          print("Avertissement: Item $itemId non trouvé dans la liste $listId.");
        }
      });
    } catch (e) {
    ...
    try {
      ...
      await _firestore.runTransaction((transaction) async {
        ...
        if (itemIndex != -1) {
          ...
          print("Avertissement: Item ${updatedItem.id} non trouvé dans la liste $listId.");
        }
      });
    } catch (e) {
